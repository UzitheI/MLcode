...
plt.style.use('/home/uzi/Documents/MLcode/learning_contour.py/styles/deeplearning.mplstyle')
...
def load_house_data():
    data = np.loadtxt("/home/uzi/Documents/MLcode/learning_contour.py/styles/houses.txt", delimiter=',', skiprows=1)
    X = data[:,:4]
    y = data[:,4]
    return X, y
